...
use super::{
    ...
    merge_model_manifest_entry, mlx_catalog_status, person_readiness_from_workers,
    safe_download_dir, safe_repo_dir_name, strip_jsonc_comments, sweep_stale_lora_uploads_before,
    EventHub, EventMessage, Settings, WorkerCapability, WorkerSnapshot, WorkerStatus,
